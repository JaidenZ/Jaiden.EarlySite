namespace EarlySite.Drms.Spefication.ShakeSpefication
{
    ...
    public class ShakeNearShopSpefication : SpeficationBase
    {
        ...
        {
            string sql = string.Format("select ShopId,ShopName,Longitude,Latitude,UpdateDate,Description where  Latitude >= ‘{0}’ and Latitude <= '{1}' and Longitude >= ‘{2}‘ and Longitude <= '{3}'", _southwest.Latitude, _northeast.Latitude, _southwest.Longitude, _northeast.Longitude);
