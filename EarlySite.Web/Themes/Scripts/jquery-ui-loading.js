    ...
    $.fn.EaLoading =function(option) {
        ...
        function openLayer() {
           ...
           //图片及文字层
            ...
            //设置高度 : 滚动条到顶部的垂直高度 + 可见区域高度/2
            var screentop = $(document).scrollTop() + document.documentElement.clientHeight/2;
            content.css("top", (parseFloat(screentop))).css("left",(parseFloat(left)-opt.width/2));
